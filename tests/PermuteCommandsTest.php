...
namespace TurnPermute;

use PHPUnit\Framework\TestCase;
use Symfony\Component\Console\Output\BufferedOutput;

class PermuteCommandsTest extends TestCase implements CommandTesterInterface
{
    ...
    public function setUp(): void
    {
        ...
        $this->commandClasses = [ \TurnPermute\Cli\PermuteCommands::class ];
        $this->setupCommandTester('TestFixtureApp', '1.0.1');
    }

    /**
     * Data provider for testPermuteCommands.
     *
     ...
     */
    public function permuteTestCommandParameters()
    {
        return [
